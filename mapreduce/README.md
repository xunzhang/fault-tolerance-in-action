1. Make sure you have [boost](http://www.boost.org/) and [gflags](https://gflags.github.io/gflags/) successfully installed. Of course you can use `brew`, `apt-get` or `yum`.
2. Build: `make`
